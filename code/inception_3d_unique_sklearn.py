...
def create_model(myoptimizer=sgd):
    ...
    model.compile(loss='categorical_crossentropy', optimizer=myoptimizer, metrics=['accuracy', 'precision', 'recall', 'fmeasure'])
...
#
score = model.evaluate_generator(data_generator.generator_tf(unique_tf_valid_path),
