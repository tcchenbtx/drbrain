...
# from utils import inceptv3_data_generator_3d_tf
...
with h5py.File(total_tf_matrix_path, 'r') as hf:
    X = hf.get('X')
    Y = hf.get('Y')
    print(X.shape)
    print(Y.shape)
...
# fit model
# history = model.fit_generator(inceptv3_data_generator_3d_tf(train_x_input_file, train_y_input_file, "train_X_input", "train_Y_input"),
#                     samples_per_epoch=500, nb_epoch=10, verbose=1,
#                     validation_data=inceptv3_data_generator_3d_tf(valid_x_input_file, valid_y_input_file, "valid_X_input", "valid_Y_input"),
#                     nb_val_samples=32)
#
...
#
# score = model.evaluate_generator(inceptv3_data_generator_3d_tf(valid_x_input_file, valid_y_input_file, "valid_X_input", "valid_Y_input"),
